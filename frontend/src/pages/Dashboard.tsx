          ...
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd className="text-2xl font-semibold text-gray-900">28.5%</dd>
              </dl>
            </div>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div>
                <p className="font-medium text-gray-900">Summer Sale Email</p>
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div>
                <p className="font-medium text-gray-900">Product Launch Newsletter</p>
          ...
          <div className="space-y-3">
            <div className="p-3 bg-primary-50 rounded-lg border border-primary-200">
              <p className="text-sm text-gray-700">
                📧 <strong>Tip:</strong> Your email open rate increases by 15% when sent on Tuesday mornings at 10 AM
              </p>
            </div>
            <div className="p-3 bg-primary-50 rounded-lg border border-primary-200">
              <p className="text-sm text-gray-700">
                ✨ <strong>Suggestion:</strong> Try A/B testing subject lines with emojis to improve engagement
              </p>
            </div>
          </div>
        </div>
